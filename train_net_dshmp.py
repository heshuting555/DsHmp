...
from dshmp.evaluation import inference_on_dataset
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        elif evaluator_type == "ytvis" or evaluator_type == "mevis":
    ...
    def build_train_loader(cls, cfg):
        ...
        for d_i, dataset_name in enumerate(cfg.DATASETS.TRAIN):
            if dataset_name.startswith('mevis'):
                mappers.append(
                    MeViSDatasetMapper(cfg, is_train=True, is_tgt=(d_i==len(cfg.DATASETS.TRAIN)-1), src_dataset_name=dataset_name)
                )
            else:
                raise NotImplementedError
    ...
    def build_optimizer(cls, cfg, model):
        ...
        for module_name, module in model.named_modules():
            for module_param_name, value in module.named_parameters(recurse=False):
                ...
                if "backbone" in module_name and "fusion" not in module_name:
