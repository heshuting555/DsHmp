...
class MaskFormerHead(nn.Module):
    ...
    def forward(self, features, lang_feat, lang_mask, mask=None, static_feat=None):
        return self.layers(features, lang_feat, lang_mask, mask, static_feat)

    def layers(self, features, lang_feat, lang_mask, mask=None, static_feat=None):
        ...
        if self.transformer_in_feature == "multi_scale_pixel_decoder":
            predictions = self.predictor(multi_scale_features, mask_features, clip_mask_features, lang_feat, lang_mask, mask, static_feat)
        else:
